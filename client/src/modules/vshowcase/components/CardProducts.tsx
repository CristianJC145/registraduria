...
const CardProducts: React.FC<CardProps> = ({ imageSrc, description, price, sellerName, shippingPrice, url }) => {
    const shipments = shippingPrice == 'Gratis' || 0 ? `Envío Gratis` : `Envío $${shippingPrice}`
  return (
    <CardProductStyles>
      <a href={url} className="vs-cardProducts">
...
.vs-cardProducts {
  ...
  box-shadow: 0 0 3px 0 rgba(41, 41, 42, 0.02);
  text-decoration: none;
}
.vs-cardProducts:hover, .vs-cardProducts:focus {
  box-shadow: 1px 4px 12px 0 rgba(41, 41, 42, 0.1);
}
...
@media (min-width: 768px) {
  .vs-cardProducts {
    box-shadow: 0 0 5px 0 rgba(41, 41, 42, 0.02); 
  }
  .vs-cardProducts-image {
    width: 100%;
    height: 100%;
...
@media (min-width: 992px) {
  .vs-cardProducts:hover, .vs-cardProducts:focus {
    box-shadow: 1px 4px 14px 0 rgba(41, 41, 42, 0.1);
  }
  .vs-cardProducts-info {
