...
export const login = async (req: Request, res: Response) => {
  ...
  try {
    ...
    const token = jwt.sign({
      id: userCredentials.idUser, idStatus: userCredentials.idStatus, idPerson: userCredentials.idPerson, username: userCredentials.username, idRole: userCredentials.idRole,
